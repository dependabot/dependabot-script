# This script is designed to loop through all dependencies in a GHE project,
# creating PRs where necessary.
#
# It is intended to be used as a stop-gap until Dependabot launches an on-prem
# solution for GitHub Enterprise (coming soon!)
...
repo_name = ENV["PROJECT_PATH"] # myaccount/myproject
